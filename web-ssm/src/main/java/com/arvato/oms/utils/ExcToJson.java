...
public class ExcToJson {
    ...
    public  ExceptionModel  changestatus(ExceptionModel  obolist1){
        change(obolist1);
        return obolist1;
    }

    public void change(ExceptionModel  obolist1){
    ...
    public RefoundOrderModel refChange(RefoundOrderModel ibolist1){
        transferstatus(ibolist1);
        return ibolist1;
    }


    public void transferstatus(RefoundOrderModel  ibolist1){
